...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_DEF] = LAYOUT(
        ...
        CU_GRV,    KC_1,    KC_2,    CU_3,    KC_4,    KC_5,    CU_6,    CU_7,    CU_8,    CU_9,    CU_0,    KC_SLSH,  CU_EQL,   KC_BSPC,          KC_HOME,
        KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    DE_Y,    KC_U,    KC_I,    KC_O,    KC_P,    CU_LBRC,  CU_RBRC,  CU_BSLS,          KC_PGUP,
        OSL(_UML), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    CU_SCLN, CU_QUOT,            KC_ENT,           KC_PGDN,
    ...
    [_NOMOD] = LAYOUT(
        ...
        OSL(_UML), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,             KC_ENT,           KC_PGDN,
